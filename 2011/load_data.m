...
%%  Brewer setup
clear all;
file_setup='calizo2011_setup';
run(fullfile('..','..',file_setup));     % configuracion por defecto

Cal.Date.day0=datenum(2011,1,1);  Cal.Date.dayend=datenum(2011,12,31); 
Date.CALC_DAYS=Cal.Date.day0:Cal.Date.dayend; Cal.Date=Date;

Cal.file_save  = 'triad_comp2011'; 
...
% SL_corr_flag.old(~isnan(SL_corr_flag.old(:,4)) & SL_corr_flag.old(:,1)>=datenum(2011,11,8),4)=1;
