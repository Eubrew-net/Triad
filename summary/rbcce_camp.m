...
%%
figure
ax_blind=sortrows(aux_blind,2);
boxplot(ax_blind(:,3),datestr(ax_blind(:,2),'yyyy/mm'),'datalim',[-4.5,4.5])
grid
title('Blind Days 2009-2015 RBCC-E Arosa/Huelva campaings')
printfiles_report(gcf,'.','aux_pattern',{'all'},'Height',9,'Width',13,'Format','png');
