...
%thisYear=datestr(now,'yyyy'); %J
thisYear='2019'; %is already on the name off the confirguration
...
%% Operative is 1st, alternative is 2nd
  brw_config_files={
    '..\157\config157.cfg','..\157\config157_a.cfg','0365','0365';    %..\157\ICF01218.157'
    '..\183\config183.cfg','..\183\config183_a.cfg','0308','0308';  % tiene que ser entero
    '..\185\config185.cfg','..\185\config185_a.cfg','0365','0365';
   };

% use if you use icf files, filter correction are not on icf  
Cal.ETC_C={
             [0,0,0,0,0,0]          %157
             [0,0,0,0,0,0]         %183
             [0,0,0,0,0,0]         %185
