% options_pub.outputDir=fullfile('..','html','Brewer185'); options_pub.showCode=true;
% close all; publish(fullfile(pwd,'comp_185.m'),options_pub);

%% Chequeamos eventos y corrección por SL -> creamos summarios con flag_sl=1
close all

comp.analyzed_brewer=[183 185]; % Instrumentos con los que vamos a trabajar
...
Cal.n_inst=3; [ratios ratios_SL]=report_comp(Cal,comp,'summary',summ_old); 
