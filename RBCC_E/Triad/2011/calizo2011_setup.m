...
Cal.file_save='calizo_2011.mat';
Cal.campaign='Izana (Spain), 29 June - 10 August, 2011';
...
Date.cal_year=2011; Date.cal_month=6;
...
for iz=1:Cal.n_brw
    ...
    if iz<4
      ...
      [inc_n,incidences_text{iz}]=xlsread(fullfile(Cal.path_root,'..','configs',['icf',Cal.brw_str{iz},'.xls']),...
