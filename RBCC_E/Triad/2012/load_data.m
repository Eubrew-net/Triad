...
% SL_corr_flag.old(~isnan(SL_corr_flag.old(:,3)) & SL_corr_flag.old(:,1)>=datenum(2012,12,12),3)=1;
...
Cal.brw=[157 183 185];
[ref,ratio_ref]=join_summary(Cal,summary_old,reference_brw,analyzed_brewer,5);
