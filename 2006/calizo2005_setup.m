...
if exist('alberto','file' )
  ...
  if ispc
     Cal.path_root=fullfile(cell2mat(regexpi(pwd,'^[A-Z]:', 'match')),'CODE','iberonesia');
      ...
      if ismac
        Cal.path_root=fullfile(filesep,'Users',linuxUser,'CODE','iberonesia')
      else    
...
Cal.path_root=fullfile(Cal.path_root,'xRBCC_Ea',num2str(Date.cal_year));
...
%% Operative is 1st, alternative is 2nd
  brw_config_files={
    ...
    '..\185\config185.cfg','..\185\config185_a.cfg','0312','0312';
    %'..\220\icf03116.220','..\220\icf03416.220','0347','0347';     % initial configuration
   };
