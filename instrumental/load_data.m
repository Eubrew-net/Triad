...
for ii=Cal.n_ref
    ...
    display_table(cat(2,round(data_tab.m(:,2)),round(data_tab.std(:,2),1),round(data_tab.m(:,3)),round(data_tab.std(:,3),1),data_tab.N(:,1)),...
    ...
    % SL report plots
     ...
     printfiles_report(gcf,Cal.dir_figs,'aux_pattern' ,str(ii),'Width',Width*2,'Height',Height*1.5,'LineMode','Scaled');
     snapnow; 
